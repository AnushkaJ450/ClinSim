#' Validates two-sample mean sample size using simulation
#'
#' @description
...
mean2power <-  function(alpha, beta, sigma, k, margin,
                               alpha_test = 0.05, n_sim = 10000){

  #Computes Sample Sizes
  n1 <- TrialSize::TwoSampleMean.Equality(alpha, beta, sigma, k, margin)
  n2 <- n1/k
